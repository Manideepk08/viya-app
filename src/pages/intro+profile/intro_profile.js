...
import AppInfoAndReviews from '../../components/AppInfoAndReviews';
...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="layout-container flex h-full min-h-screen grow flex-col relative" style={{ fontFamily: 'Epilogue, Noto Sans, sans-serif' }}>
      {/* Registration Section with background */}
      <div className="w-full min-h-screen flex flex-col" style={{ backgroundImage: 'url(/wedding_card.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex flex-1 justify-center items-center px-4">
            <div className="w-full max-w-md">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 overflow-hidden">
                {/* Role Selection */}
      ...
      {/* Highlights Section with its own background */}
      <AppInfoAndReviews />
    </div>
  );
};
